...
6. **Write design doc** — save to `docs/superpowers/specs/YYYY-MM-DD-<topic>-design.md`; in Plan Mode use `save_superpowers_artifact(kind="spec")` and do not commit
...
If the environment is outside Plan Mode and you committed the spec, say "Spec written and committed to `<path>`" instead.
